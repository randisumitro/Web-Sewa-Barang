...
<body>
	<main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
      ...
      <input type="hidden" name="delivery_type" value="pickup" id="delivery_type"/>
      <input type="number" name="duration" id="duration" value="1" class="absolute -z-10 opacity-0 w-1"
						required />
