...
class FrontController extends Controller
{
    ...
    public function checkout_store(StorePaymentRequest $request){
        ...
        $bookingData = session()->only(['duration', 'started_at', 'store_id', 'delivery_type', 'address',
        'product_id']);
        ...
        //closure transaction database transaction
    ...
    public function transactions_details(Request $request){
        $request->validate([
            'trx_id' => ['required', 'string', 'max:225'],
        ...
        return view('front.transactions_details', compact('details', 'totalPpn', 'subTotal', 'insurance'));
    }
